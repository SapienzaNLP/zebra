...
retriever_output_path="data/zebra_retriever/outputs/arc/easy/arc_easy_dev.arc_train.jsonl"

# Dataset path
data_path="data/datasets/arc/easy/arc-easy-dev.jsonl"
...
# Output dir
output_dir="results/zebra/arc/easy/dev"
